...
export default function Detail() {
    const technologies = [
        { name: "HTML", color: "bg-orange-500/10 text-orange-400" },
        { name: "CSS", color: "bg-blue-500/10 text-blue-400" },
                ...
                <div className="bg-gray-100/80 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-300/50 dark:border-gray-700/50 rounded-2xl p-8 shadow-xl relative overflow-hidden">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-gray-600 dark:text-gray-300">
                                <li className="flex items-start gap-2">
                                    ...
                                    <span>
                                        Recherche de météo par ville en temps
                                        réel
                                    </span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-emerald-400">•</span>
                                    <span>
                                        Affichage des températures, conditions
                                        et prévisions
                                    </span>
                                </li>
                                <li className="flex items-start gap-2">
                    ...
                    >
                        <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 shadow-lg hover:shadow-emerald-500/25 z-20 cursor-pointer"
                        >
                            <FiExternalLink />
