          ...
          <div className="container mx-auto flex items-center justify-between">
            <div className="content max-w-md">
              ...
              <ul className="social-icons mt-4">
                <li><Link href="#" className="text-gray-600 hover:text-green-500"><i className="fab fa-github"></i></Link></li>
                <li><Link href="#" className="text-gray-600 hover:text-green-500"><i className="fab fa-linkedin"></i></Link></li>
              </ul>
            </div>
            <div className="image pdp">
              <Image className="avatar" src="/img/mo.png" width={300} height={200} alt="Alex Morel"/>
            </div>
          </div>
        </section>
      </main>
